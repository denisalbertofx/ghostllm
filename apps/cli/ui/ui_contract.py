...
STARTUP_LABEL_PERMISSIONS = "permissions"
STARTUP_LABEL_EMPIEZA = "empieza con"
STARTUP_HINT_SLASH = "escribe `/` para abrir acciones"
STARTUP_HINT_CONTROLS = "↑↓ historial/menu · Tab completa · Esc cierra"
PROMPT_HANDLE = "ghost"
...
PANEL_TITLE_PLAN_MODE = "PLAN MODE"
PANEL_SUBTITLE_PLAN_MODE = "read-only · no changes will be made"
